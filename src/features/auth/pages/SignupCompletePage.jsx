  ...
  return (
    <main className="signup-complete-page">
      <section className="signup-complete-card">
        <h1>회원가입</h1>
        <div className="signup-complete-title-line" />

        <SignupStepper currentStep={4} />

        <div className="signup-complete-section-title">가입 완료</div>
        <div className="signup-complete-section-line" />
        ...
        <div className="signup-complete-bottom-line" />
      </section>
    </main>
  );
}
